...
import { MapPin, Phone, Mail, Instagram, Facebook, ExternalLink, Check, X } from 'lucide-react';
...
export const Footer: React.FC = () => {
  ...
  const terms = {
    ...
    items: [
      {
        mr: 'टेबल आरक्षण परत केले जाणार नाही.',
        hi: 'टेबल आरक्षण वापस नहीं किया जाएगा।',
        en: 'Table reservation is non-refundable.'
      },
      {
        mr: 'हिंसाचार आणि अश्लील भाषेवर कठोर बंदी आहे.',
        hi: 'हिंसा और अश्लील भाषा पर सख्त प्रतिबंध है।',
        en: 'Strict prohibition of violence & vulgar language.'
      },
      {
        mr: '२१ वर्षाखालील व्यक्तींना मद्यपान सेवा दिली जाणार नाही.',
        hi: '21 वर्ष से कम आयु के व्यक्तियों को शराब परोसी नहीं जाएगी।',
        en: 'Persons under 21 years of age will not be served alcohol.'
      },
      {
        mr: 'बारच्या वेळेतच आरक्षण उपलब्ध आहे.',
        hi: 'आरक्षण केवल बार के समय के दौरान उपलब्ध है।',
        en: 'Reservations are available only during bar timings.'
      },
      {
        mr: 'ओळखपत्र सोबत आणा (कोणताही सरकारी आयडी).',
        hi: 'पहचान प्रमाण साथ लाएं (कोई भी सरकारी आईडी)।',
        en: 'Carry proof of identity (any Government-issued ID).'
      }
    ]
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            >
              ...
              <div className="space-y-3">
                <p className="text-[#D4AF37] font-semibold text-lg">{ownerInfo.name[language]}</p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-6 text-sm">
                ...
                <button
                  ...
                  className="text-[#F5F5DC]/60 hover:text-[#D4AF37] transition-colors cursor-pointer"
                >
        ...
        {showTerms && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-lg rounded-3xl border border-[#D4AF37]/40 bg-[#0A0A0A] p-8 md:p-10 shadow-[0_0_60px_rgba(212,175,55,0.15)]"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close Button */}
              <button
                onClick={() => setShowTerms(false)}
                className="absolute top-4 right-4 w-9 h-9 rounded-full border border-[#D4AF37]/30 flex items-center justify-center text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#0A0A0A] transition-all"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              <div className="h-px bg-gradient-to-r from-[#D4AF37]/60 to-transparent mb-6" />

              {/* Terms List */}
              <ul className="space-y-4">
                {terms.items.map((item, index) => (
                  <li key={index} className="flex items-start gap-4">
                    <span className="flex-shrink-0 w-7 h-7 rounded-full bg-gradient-to-br from-[#B8860B] to-[#D4AF37] text-[#0A0A0A] text-xs font-bold flex items-center justify-center mt-0.5">
                      {index + 1}
                    </span>
                    <p className="text-[#F5F5DC]/85 text-sm leading-relaxed">{item[language]}</p>
                  </li>
                ))}
              </ul>

              {/* Footer note */}
              <div className="mt-8 p-4 rounded-2xl border border-[#D4AF37]/20 bg-[#D4AF37]/5">
                <p className="text-[#F5F5DC]/50 text-xs text-center">
                  {language === 'mr'
                    ? 'Hotel Ronak & Beer Bar मध्ये प्रवेश केल्याने या अटी मान्य केल्या असे समजले जाते.'
                    : language === 'hi'
                    ? 'Hotel Ronak & Beer Bar में प्रवेश करके आप इन नियमों को स्वीकार करते हैं।'
                    : 'By entering Hotel Ronak & Beer Bar, you agree to these terms.'}
                </p>
              </div>
              ...
              <button
                onClick={() => setShowTerms(false)}
                className="mt-6 w-full py-3 rounded-xl bg-gradient-to-r from-[#B8860B] to-[#D4AF37] text-[#0A0A0A] font-bold text-sm tracking-wide hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all"
              >
                {language === 'mr' ? 'समजले' : language === 'hi' ? 'समझ गया' : 'I Understand'}
              </button>
            </motion.div>
          </motion.div>
        )}
